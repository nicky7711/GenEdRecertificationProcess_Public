<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AdminViewQuestionnaire.aspx.cs" Inherits="CIS4396Solution.AdminViewQuestionnaire" %>
        ...
        <div class="card">
            ...
            <div class="row">
                <div class="col-xs-10 col-xs-offset-1">
                    <div class="pull-left">
                        <asp:DropDownList CssClass="form-control" runat="server" ID="ddlQuestionnaire" Width="100%" OnSelectedIndexChanged="ddlQuestionnaire_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                    </div>
                </div>
            </div>
            <br />
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div style="margin-left: 5%">
                                                    <asp:RadioButtonList CssClass="radio" ID="radioFidelity1" runat="server" Enabled="false">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <asp:CheckBoxList CssClass="checkbox" ID="chkVariance" runat="server" Enabled="false">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <asp:TextBox CssClass="form-control" ID="txtDiscrepancy" runat="server" TextMode="MultiLine" Rows="4" Enabled="false"></asp:TextBox>
                                                <br />
                                                ...
                                                <asp:RadioButtonList CssClass="radio" ID="radioPortfolios" runat="server" Enabled="false">
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="col-md-4">
                                                <div style="margin-left: 5%">
                                                    ...
                                                    <asp:RadioButtonList CssClass="radio" ID="radioConsistency1" runat="server" Enabled="false">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <asp:CheckBoxList CssClass="checkbox" ID="chkInconsistency" runat="server" Enabled="false">
                                            ...
                                            <div class="col-md-4">
                                                <h4>Please elaborate on why you find the discrepancies to be potentially problematic</h4>
                                                <asp:TextBox CssClass="form-control" ID="txtProblematic" runat="server" TextMode="MultiLine" Rows="4" Enabled="false"></asp:TextBox>
                                                <br />
                                                <h4>If you selected mostly inconsistent, please outline where you saw inconsistencies</h4>
                                                <asp:TextBox CssClass="form-control" ID="txtOutline" runat="server" TextMode="MultiLine" Rows="4" Enabled="false"></asp:TextBox>
                                            </div>
                                        </fieldset>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <fieldset>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div style="margin-left: 5%">
                                                    <asp:RadioButtonList CssClass="radio" ID="radioFidelity2" runat="server" Enabled="false">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <asp:RadioButtonList CssClass="radio" ID="radioFidelity3" runat="server" Enabled="false">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <asp:TextBox CssClass="form-control" ID="txtFidelity" runat="server" TextMode="MultiLine" Rows="4" Enabled="false"></asp:TextBox>
                                            </div>
                                        </fieldset>
                                    </div>
                                    <div class="row">
                                        <fieldset>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div style="margin-left: 5%">
                                                    <asp:RadioButtonList CssClass="radio" ID="radioConsistency2" runat="server" Enabled="false">
                                                        <asp:ListItem Value="Yes">Yes</asp:ListItem>
                                                        <asp:ListItem Value="No">No</asp:ListItem>
                                                        <asp:ListItem Value="High">There was a high level of fidelity to the original proposal</asp:ListItem>
                                                    </asp:RadioButtonList>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <asp:RadioButtonList CssClass="radio" ID="radioConsistency3" runat="server" Enabled="false">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <asp:TextBox CssClass="form-control" ID="txtConsistency" runat="server" TextMode="MultiLine" Rows="4" Enabled="false"></asp:TextBox>
                                            </div>
                                        </fieldset>
                                    </div>
                                </div>
                            ...
                            <div id="collapse3" class="panel-collapse collapse">
                                <div class="panel-body">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <table class="table table-striped">
                                                    ...
                                                    further study, or the solution to a problem.)</td>
                                                            <td>
                                                                <asp:RadioButton ID="radioYes1" runat="server" Enabled="false" /></td>
                                                            <td>
                                                                <asp:RadioButton ID="radioNo1" runat="server" Enabled="false" /></td>
                                                        </tr>
                                                        <tr>
                                                    ...
                                                    presented in a style appropriate to the context.)</td>
                                                            <td>
                                                                <asp:RadioButton ID="radioYes2" runat="server" Enabled="false" /></td>
                                                            <td>
                                                                <asp:RadioButton ID="radioNo2" runat="server" Enabled="false" /></td>
                                                        </tr>
                                                        <tr>
                                                    ...
                                                    ethical use of information.)</td>
                                                            <td>
                                                                <asp:RadioButton ID="radioYes3" runat="server" Enabled="false" /></td>
                                                            <td>
                                                                <asp:RadioButton ID="radioNo3" runat="server" Enabled="false" /></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                            <div class="col-md-4">
                                                <table>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:TextBox CssClass="form-control" ID="txtAnswerNo1" runat="server" TextMode="MultiLine" Rows="10" Enabled="false"></asp:TextBox></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <table>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:TextBox CssClass="form-control" ID="txtAnswerNo2" runat="server" TextMode="MultiLine" Rows="10" Enabled="false"></asp:TextBox></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                across geographic, chronological and cultural boundaries.)</td>
                                                            <td>
                                                                <asp:RadioButton ID="radioYes9" runat="server" Enabled="false" /></td>
                                                            <td>
                                                                <asp:RadioButton ID="radioNo9" runat="server" Enabled="false" /></td>
                                                        </tr>
                                                        <tr>
                                 ...
                                 frameworks to problems, topics, or issue.)</td>
                                                            <td>
                                                                <asp:RadioButton ID="radioYes10" runat="server" Enabled="false" /></td>
                                                            <td>
                                                                <asp:RadioButton ID="radioNo10" runat="server" Enabled="false" /></td>
                                                        </tr>
                                                        <tr>
                                 ...
                                 results and the use and misuse of scientific data.)</td>
                                                            <td>
                                                                <asp:RadioButton ID="radioYes11" runat="server" Enabled="false" /></td>
                                                            <td>
                                                                <asp:RadioButton ID="radioNo11" runat="server" Enabled="false" /></td>
                                                        </tr>
                                                        <tr>
                                 ...
                                 and an inclusion of the diverse values and interests.)</td>
                                                            <td>
                                                                <asp:RadioButton ID="radioYes12" runat="server" Enabled="false" /></td>
                                                            <td>
                                                                <asp:RadioButton ID="radioNo12" runat="server" Enabled="false" /></td>
                                                        </tr>
                                                        <tr>
                                 ...
                                 of being though readings, discussions, activities, and classes throughout GenEd.)</td>
                                                            <td>
                                                                <asp:RadioButton ID="radioYes13" runat="server" Enabled="false" /></td>
                                                            <td>
                                                                <asp:RadioButton ID="radioNo13" runat="server" Enabled="false" /></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                            <div class="col-md-4">
                                                <table>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:TextBox CssClass="form-control" ID="txtComments" runat="server" TextMode="MultiLine" Rows="10" Enabled="false"></asp:TextBox></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <fieldset>
                                            ...
                                            <div class="col-md-7">
                                                <asp:RadioButtonList ID="radioRecommendation" runat="server" Enabled="false">
                                        ...
                                        professionalism in the syllabi under review.</h5>
                                                <br />
                                                <asp:TextBox CssClass="form-control" ID="txtFinalComments" runat="server" TextMode="MultiLine" Rows="5" Enabled="false"></asp:TextBox>
                                            </div>
                                        </fieldset>
                                    </div>
                                </div>
            ...
            <div class="row">
                <div class="col-xs-10 col-xs-offset-1">
                    <div class="pull-left">
                        <asp:Button CssClass="btn btn-lg btn-primary" runat="server" ID="btnExport" Text="Export Answers" Width="100%" OnClick="btnExport_Click" />
                    </div>
                </div>
            </div>
        </div>
